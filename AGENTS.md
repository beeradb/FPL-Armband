...
- **`MinGainHit` 3.0 stands and the hits mostly pay.** The shipped arm's per-hit loss rate is
  **24.5%** below the gate's own bar (**29.7%** availability-adjusted, n 98) against a ~50%
  truncation null, mean package +15.7; the MinGainHit ladder 3/4/5/6 resolves nothing
