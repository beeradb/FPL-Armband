...
| | |
|---|---|
| snapshot taken | 2026-08-16 16:48 EDT |
| commit | `c6fa9c4cf5e5` |
| branch | `worktree-repoint-the-findings-citations` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-r3.csv` |
...
Compared against `2026-08-16-f05fefc`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | f05fefc0e7e8 | c6fa9c4cf5e5 | — |
