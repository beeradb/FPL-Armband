...
| | |
|---|---|
| snapshot taken | 2026-08-10 22:45 EDT |
| commit | `774a2b49f25b` |
| branch | `club-error-timescale` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/5340a581/tmp/model2.csv` |
...
Compared against `2026-08-10-a14ab00`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | a14ab006bc58 | 774a2b49f25b | — |
