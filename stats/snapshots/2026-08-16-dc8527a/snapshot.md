...
| | |
|---|---|
| snapshot taken | 2026-08-16 09:22 EDT |
| commit | `dc8527a6685f` |
| branch | `integrate-the-tier-1-batch` |
| cells file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/cells.csv` |
| model file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model.csv` |
| inference for MINHL#1 | `stats/out/cells` |
...
- the model CSV /home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model.csv holds 8 runs (newest 1786885822-1886176 wins per figure). It appends and its path is outside the repo, so confirm every run in it came from this commit — a stale run from another branch is how 2026-08-15-9e743cf shipped pre-fix clean-sheet figures under a commit that had the fix

### Sweep `MINHL#1`

| | |
|---|---|
| ran at commit | `4f67cc92bc48`, tree dirty |
...
Compared against `2026-08-16-7fa6de7`.
...
| `stamp.commit` | 7fa6de7b9280 | dc8527a6685f | — |
...
- `harness.minhl_1.mde_season.policy.half_life_2.clustered` = 100
- `harness.minhl_1.mde_season.policy.half_life_2.startfixed` = 46
- `harness.minhl_1.mde_season.policy.half_life_8.clustered` = 65
- `harness.minhl_1.mde_season.policy.half_life_8.startfixed` = 50
- `harness.minhl_1.mde_season.policy.half_life_20.clustered` = 92
- `harness.minhl_1.mde_season.policy.half_life_20.startfixed` = 46
- `harness.minhl_1.mde_season.policy` = 102
- `harness.minhl_1.sig_season.policy` = 75
...
- `sweep.MINHL#1.commit` = 4f67cc92bc48
...
- `harness.minhl_1.sd_season.policy` = 1.597
- `harness.minhl_1.sd_resid.policy` = 2.464
- `harness.minhl_1.share_season.policy` = 72
