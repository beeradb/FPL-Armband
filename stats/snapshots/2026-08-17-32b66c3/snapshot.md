...
| | |
|---|---|
| snapshot taken | 2026-08-17 04:42 EDT |
| commit | `32b66c35bcab` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/fixture-snapshot-model.csv` |
...
Compared against `2026-08-17-0d34fa0`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 0d34fa09f39d | 32b66c35bcab | — |
