...
| | |
|---|---|
| snapshot taken | 2026-08-20 09:28 EDT |
| commit | `1546574bb0ab` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/9912b5db/tmp/model-copysnap.csv` |
...
Compared against `2026-08-20-e642fe9`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | e642fe9ed668 | 1546574bb0ab | — |
