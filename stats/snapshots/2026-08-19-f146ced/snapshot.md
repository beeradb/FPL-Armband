...
| | |
|---|---|
| snapshot taken | 2026-08-19 11:39 EDT |
| commit | `f146ced79ca7` |
| cells file | `not supplied` |
| model file | `/tmp/claude-501/-home-bbowman-guest-fpl/59c4da91-9003-4a0c-8807-d48d9b7c5d94/scratchpad/model-snapshot.csv` |
...
Compared against `2026-08-19-d8d2897`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | d8d2897b5b75 | f146ced79ca7 | — |
