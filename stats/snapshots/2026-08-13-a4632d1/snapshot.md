...
| | |
|---|---|
| snapshot taken | 2026-08-13 17:32 EDT |
| commit | `a4632d13e095` |
| branch | `xgc-transport-test` |
| cells file | `not supplied` |
| model file | `/tmp/model-xgctransport.csv` |
...
Compared against `2026-08-13-b2a3d9c`.
...
| `stamp.commit` | b2a3d9c97591 | a4632d13e095 | — |
