...
| | |
|---|---|
| snapshot taken | 2026-08-21 15:24 EDT |
| commit | `95c307275d0d` — **working tree was dirty**, so this commit alone does not identify the code that ran |
...
Compared against `2026-08-21-3221944`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 3221944c7539 | 95c307275d0d | — |
