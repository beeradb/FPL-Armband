...
| | |
|---|---|
| snapshot taken | 2026-08-22 08:45 EDT |
| commit | `66fb97159a8e` |
...
|---|---:|---:|---:|---:|---:|---:|
| model built through GW4 | 1047 | 3.026 | 2.733 | 0.903 | -0.293 | 1.373 |
| model built through GW8 | 1071 | 3.035 | 2.863 | 0.943 | -0.172 | 1.308 |
| model built through GW12 | 1062 | 3.054 | 2.843 | 0.931 | -0.211 | 1.374 |
| model built through GW16 | 1052 | 3.051 | 2.752 | 0.902 | -0.3 | 1.452 |
| model built through GW20 | 986 | 3.063 | 3.01 | 0.983 | -0.053 | 1.38 |
| model built through GW24 | 1037 | 3.065 | 2.991 | 0.976 | -0.074 | 1.358 |
| model built through GW28 | 1053 | 3.044 | 2.787 | 0.916 | -0.257 | 1.352 |
| model built through GW32 | 1047 | 3.03 | 3.111 | 1.027 | 0.081 | 1.393 |
...
|---|---:|---:|---:|---:|---:|
| points — model — Zeros | 14189 | 1.524 | 1.843 | 1.524 | 1.036 |
| points — model — Blanks | 29259 | 1.197 | 1.559 | 1.02 | 1.179 |
| points — model — Tickers | 5321 | 1.149 | 1.494 | -0.419 | 1.434 |
| points — model — Haulers | 11785 | 4.807 | 5.625 | -4.736 | 3.035 |
| points — model — all categories | 60554 | 1.972 | 2.885 | -0.109 | 2.883 |
...
| minutes — model — Zeros | 14189 | 40.374 | 45.845 | 40.374 | 21.718 |
| minutes — model — Blanks | 29259 | 23.651 | 30.11 | -9.224 | 28.662 |
| minutes — model — Tickers | 5321 | 24.402 | 31.88 | -19.918 | 24.892 |
| minutes — model — Haulers | 11785 | 24.097 | 31.732 | -21.169 | 23.639 |
| minutes — model — all categories | 60554 | 27.723 | 34.869 | -0.866 | 34.858 |
...
| expected goals + assists — model — Blanks | 29259 | 0.113 | 0.174 | 0.029 | 0.172 |
...
|---|---:|---:|---:|---:|
| predicted under 1.0 | 8457 | 0.643 | 0.833 | 1.296 |
| predicted 1.0 to 2.0 | 17437 | 1.513 | 1.699 | 1.123 |
| predicted 2.0 to 3.0 | 18605 | 2.488 | 2.581 | 1.037 |
| predicted 3.0 to 4.0 | 11093 | 3.416 | 3.501 | 1.025 |
| predicted 4.0 to 5.0 | 2790 | 4.402 | 4.24 | 0.963 |
| predicted 5.0 to 6.0 | 1056 | 5.437 | 5.255 | 0.966 |
| predicted 6.0 and above | 1116 | 7.368 | 7.109 | 0.965 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CONTROL, directional: minutes recency off — points | 60554 | 0.041 | 0.078 | 0.114 | 0.072 | — | — |
| CONTROL, directional: minutes recency off — minutes | 60554 | 3.891 | 4.231 | 3.128 | 4.037 | — | — |
| CONTROL, directional: minutes recency off — expected goals + assists | 60554 | 0.001 | 0.005 | 0.005 | 0.004 | — | — |
| CONTROL, directional: minutes recency off — tail and ordering | 0 | — | — | — | — | 0.041 | -0.088 |
...
| CANDIDATE: appearance constants refit on the windowed population — tail and ordering | 0 | — | — | — | — | -0.155 | -0.003 |
...
| CANDIDATE: appearance constants refit against ExpectedMinutes — tail and ordering | 0 | — | — | — | — | -0.081 | 0 |
...
| CANDIDATE: the sixty-minute curve alone, refit against ExpectedMinutes — tail and ordering | 0 | — | — | — | — | -0.079 | 0 |
...
| CANDIDATE: rate recency, half-life 8 — tail and ordering | 0 | — | — | — | — | 0.042 | 0.001 |
...
*Population: 515 moves judged, 6 seasons x 3 start points, min_gain 0.40.*

| | n | median | mean |
|---|---:|---:|---:|
| buy side (player bought) | 515 | -0.232 | 0.012 |
| sell side (player sold) | 515 | -0.408 | -0.379 |
| asymmetry (buy minus sell) | 515 | 0.176 | 0.391 |
| sell error: sold player played again | 443 | -0.314 | — |
| sell error: sold player never played again | 72 | -2.494 | — |
...
Compared against `2026-08-22-eb78ef0`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `model.calibration_drift.model_built_through_gw12.actual` | 2.8423 | 2.8431 | +0.0008 |
| `model.calibration_drift.model_built_through_gw12.bias` | -0.2142 | -0.2113 | +0.0029 |
| `model.calibration_drift.model_built_through_gw12.mean_absolute_error` | 1.3739 | 1.3741 | +0.0002 |
| `model.calibration_drift.model_built_through_gw12.predicted` | 3.0565 | 3.0544 | -0.0021 |
| `model.calibration_drift.model_built_through_gw12.ratio` | 0.9299 | 0.9308 | +0.0009 |
| `model.calibration_drift.model_built_through_gw16.actual` | 2.7502 | 2.7515 | +0.0013 |
| `model.calibration_drift.model_built_through_gw16.bias` | -0.3019 | -0.2997 | +0.0022 |
| `model.calibration_drift.model_built_through_gw16.mean_absolute_error` | 1.4513 | 1.4520 | +0.0007 |
| `model.calibration_drift.model_built_through_gw16.predicted` | 3.0522 | 3.0512 | -0.001 |
| `model.calibration_drift.model_built_through_gw16.ratio` | 0.9011 | 0.9018 | +0.0007 |
| `model.calibration_drift.model_built_through_gw20.actual` | 3.0126 | 3.0103 | -0.0023 |
| `model.calibration_drift.model_built_through_gw20.bias` | -0.0541 | -0.0528 | +0.0013 |
| `model.calibration_drift.model_built_through_gw20.mean_absolute_error` | 1.3792 | 1.3800 | +0.0008 |
| `model.calibration_drift.model_built_through_gw20.predicted` | 3.0667 | 3.0631 | -0.0036 |
| `model.calibration_drift.model_built_through_gw20.ratio` | 0.9823 | 0.9828 | +0.0005 |
| `model.calibration_drift.model_built_through_gw24.actual` | 2.9931 | 2.9909 | -0.0022 |
| `model.calibration_drift.model_built_through_gw24.bias` | -0.0733 | -0.0744 | -0.0011 |
| `model.calibration_drift.model_built_through_gw24.mean_absolute_error` | 1.3587 | 1.3575 | -0.0012 |
| `model.calibration_drift.model_built_through_gw24.predicted` | 3.0664 | 3.0654 | -0.001 |
| `model.calibration_drift.model_built_through_gw24.ratio` | 0.9761 | 0.9757 | -0.0004 |
| `model.calibration_drift.model_built_through_gw28.bias` | -0.2577 | -0.2571 | +0.0006 |
| `model.calibration_drift.model_built_through_gw28.mean_absolute_error` | 1.3521 | 1.3522 | +0.0001 |
| `model.calibration_drift.model_built_through_gw28.predicted` | 3.0449 | 3.0444 | -0.0005 |
| `model.calibration_drift.model_built_through_gw28.ratio` | 0.9154 | 0.9155 | +0.0001 |
| `model.calibration_drift.model_built_through_gw32.bias` | 0.0798 | 0.0805 | +0.0007 |
| `model.calibration_drift.model_built_through_gw32.mean_absolute_error` | 1.3926 | 1.3928 | +0.0002 |
| `model.calibration_drift.model_built_through_gw32.predicted` | 3.0312 | 3.0304 | -0.0008 |
| `model.calibration_drift.model_built_through_gw32.ratio` | 1.0263 | 1.0266 | +0.0003 |
| `model.calibration_drift.model_built_through_gw4.actual` | 2.7302 | 2.7328 | +0.0026 |
| `model.calibration_drift.model_built_through_gw4.bias` | -0.2960 | -0.2928 | +0.0032 |
| `model.calibration_drift.model_built_through_gw4.mean_absolute_error` | 1.3740 | 1.3725 | -0.0015 |
| `model.calibration_drift.model_built_through_gw4.predicted` | 3.0262 | 3.0256 | -0.0006 |
| `model.calibration_drift.model_built_through_gw4.ratio` | 0.9022 | 0.9032 | +0.001 |
| `model.calibration_drift.model_built_through_gw8.actual` | 2.8659 | 2.8633 | -0.0026 |
| `model.calibration_drift.model_built_through_gw8.bias` | -0.1737 | -0.1717 | +0.002 |
| `model.calibration_drift.model_built_through_gw8.mean_absolute_error` | 1.3103 | 1.3081 | -0.0022 |
| `model.calibration_drift.model_built_through_gw8.predicted` | 3.0396 | 3.0350 | -0.0046 |
| `model.calibration_drift.model_built_through_gw8.ratio` | 0.9429 | 0.9434 | +0.0005 |
| `model.prediction_benchmark.expected_goals_assists_model_all_categories.bias_predicted_minus_actual` | 0.0011 | 0.0010 | -0.0001 |
| `model.prediction_benchmark.expected_goals_assists_model_blanks.bias_predicted_minus_actual` | 0.0292 | 0.0291 | -0.0001 |
| `model.prediction_benchmark.expected_goals_assists_model_blanks.error_sd` | 0.1722 | 0.1720 | -0.0002 |
| `model.prediction_benchmark.expected_goals_assists_model_blanks.root_mean_square_error` | 0.1747 | 0.1744 | -0.0003 |
| `model.prediction_benchmark.expected_goals_assists_model_haulers.bias_predicted_minus_actual` | -0.1662 | -0.1663 | -0.0001 |
| `model.prediction_benchmark.expected_goals_assists_model_tickers.bias_predicted_minus_actual` | -0.0107 | -0.0108 | -0.0001 |
| `model.prediction_benchmark.expected_goals_assists_model_tickers.error_sd` | 0.2105 | 0.2104 | -0.0001 |
| `model.prediction_benchmark.expected_goals_assists_model_tickers.root_mean_square_error` | 0.2108 | 0.2107 | -0.0001 |
| `model.prediction_benchmark.expected_goals_assists_model_zeros.bias_predicted_minus_actual` | 0.0863 | 0.0864 | +0.0001 |
| `model.prediction_benchmark.expected_goals_assists_model_zeros.mean_absolute_error` | 0.0863 | 0.0864 | +0.0001 |
| `model.prediction_benchmark.minutes_model_all_categories.bias_predicted_minus_actual` | -0.8480 | -0.8664 | -0.0184 |
| `model.prediction_benchmark.minutes_model_all_categories.error_sd` | 34.8494 | 34.8578 | +0.0084 |
| `model.prediction_benchmark.minutes_model_all_categories.mean_absolute_error` | 27.7017 | 27.7225 | +0.0208 |
| `model.prediction_benchmark.minutes_model_all_categories.root_mean_square_error` | 34.8597 | 34.8686 | +0.0089 |
| `model.prediction_benchmark.minutes_model_blanks.bias_predicted_minus_actual` | -9.2004 | -9.2238 | -0.0234 |
| `model.prediction_benchmark.minutes_model_blanks.error_sd` | 28.6640 | 28.6621 | -0.0019 |
| `model.prediction_benchmark.minutes_model_blanks.mean_absolute_error` | 23.6355 | 23.6512 | +0.0157 |
| `model.prediction_benchmark.minutes_model_blanks.root_mean_square_error` | 30.1043 | 30.1097 | +0.0054 |
| `model.prediction_benchmark.minutes_model_haulers.bias_predicted_minus_actual` | -21.1265 | -21.1689 | -0.0424 |
| `model.prediction_benchmark.minutes_model_haulers.error_sd` | 23.6518 | 23.6390 | -0.0128 |
| `model.prediction_benchmark.minutes_model_haulers.mean_absolute_error` | 24.0612 | 24.0971 | +0.0359 |
| `model.prediction_benchmark.minutes_model_haulers.root_mean_square_error` | 31.7134 | 31.7321 | +0.0187 |
| `model.prediction_benchmark.minutes_model_tickers.bias_predicted_minus_actual` | -19.8833 | -19.9178 | -0.0345 |
| `model.prediction_benchmark.minutes_model_tickers.error_sd` | 24.9045 | 24.8919 | -0.0126 |
| `model.prediction_benchmark.minutes_model_tickers.mean_absolute_error` | 24.3788 | 24.4021 | +0.0233 |
| `model.prediction_benchmark.minutes_model_tickers.root_mean_square_error` | 31.8682 | 31.8799 | +0.0117 |
| `model.prediction_benchmark.minutes_model_zeros.bias_predicted_minus_actual` | 40.3565 | 40.3743 | +0.0178 |
| `model.prediction_benchmark.minutes_model_zeros.error_sd` | 21.7354 | 21.7183 | -0.0171 |
| `model.prediction_benchmark.minutes_model_zeros.mean_absolute_error` | 40.3565 | 40.3743 | +0.0178 |
| `model.prediction_benchmark.minutes_model_zeros.root_mean_square_error` | 45.8375 | 45.8451 | +0.0076 |
| `model.prediction_benchmark.points_model_all_categories.bias_predicted_minus_actual` | -0.1080 | -0.1088 | -0.0008 |
| `model.prediction_benchmark.points_model_all_categories.error_sd` | 2.8832 | 2.8831 | -0.0001 |
| `model.prediction_benchmark.points_model_all_categories.mean_absolute_error` | 1.9719 | 1.9718 | -0.0001 |
| `model.prediction_benchmark.points_model_blanks.bias_predicted_minus_actual` | 1.0206 | 1.0197 | -0.0009 |
| `model.prediction_benchmark.points_model_blanks.error_sd` | 1.1803 | 1.1789 | -0.0014 |
| `model.prediction_benchmark.points_model_blanks.mean_absolute_error` | 1.1974 | 1.1965 | -0.0009 |
| `model.prediction_benchmark.points_model_blanks.root_mean_square_error` | 1.5604 | 1.5587 | -0.0017 |
| `model.prediction_benchmark.points_model_haulers.bias_predicted_minus_actual` | -4.7345 | -4.7362 | -0.0017 |
| `model.prediction_benchmark.points_model_haulers.error_sd` | 3.0360 | 3.0354 | -0.0006 |
| `model.prediction_benchmark.points_model_haulers.mean_absolute_error` | 4.8059 | 4.8071 | +0.0012 |
| `model.prediction_benchmark.points_model_haulers.root_mean_square_error` | 5.6243 | 5.6254 | +0.0011 |
| `model.prediction_benchmark.points_model_tickers.bias_predicted_minus_actual` | -0.4175 | -0.4189 | -0.0014 |
| `model.prediction_benchmark.points_model_tickers.error_sd` | 1.4351 | 1.4338 | -0.0013 |
| `model.prediction_benchmark.points_model_tickers.mean_absolute_error` | 1.1496 | 1.1493 | -0.0003 |
| `model.prediction_benchmark.points_model_tickers.root_mean_square_error` | 1.4946 | 1.4938 | -0.0008 |
| `model.prediction_benchmark.points_model_zeros.bias_predicted_minus_actual` | 1.5233 | 1.5240 | +0.0007 |
| `model.prediction_benchmark.points_model_zeros.error_sd` | 1.0360 | 1.0355 | -0.0005 |
| `model.prediction_benchmark.points_model_zeros.mean_absolute_error` | 1.5233 | 1.5240 | +0.0007 |
| `model.prediction_benchmark.points_model_zeros.root_mean_square_error` | 1.8422 | 1.8425 | +0.0003 |
| `model.prediction_calibration.predicted_1_0_to_2_0.actual` | 1.6983 | 1.6994 | +0.0011 |
| `model.prediction_calibration.predicted_1_0_to_2_0.predicted` | 1.5129 | 1.5130 | +0.0001 |
| `model.prediction_calibration.predicted_1_0_to_2_0.ratio` | 1.1226 | 1.1232 | +0.0006 |
| `model.prediction_calibration.predicted_2_0_to_3_0.actual` | 2.5806 | 2.5809 | +0.0003 |
| `model.prediction_calibration.predicted_2_0_to_3_0.predicted` | 2.4883 | 2.4881 | -0.0002 |
| `model.prediction_calibration.predicted_2_0_to_3_0.ratio` | 1.0371 | 1.0373 | +0.0002 |
| `model.prediction_calibration.predicted_3_0_to_4_0.actual` | 3.5015 | 3.5006 | -0.0009 |
| `model.prediction_calibration.predicted_3_0_to_4_0.predicted` | 3.4169 | 3.4164 | -0.0005 |
| `model.prediction_calibration.predicted_3_0_to_4_0.ratio` | 1.0248 | 1.0246 | -0.0002 |
| `model.prediction_calibration.predicted_4_0_to_5_0.actual` | 4.2382 | 4.2401 | +0.0019 |
| `model.prediction_calibration.predicted_4_0_to_5_0.predicted` | 4.4013 | 4.4015 | +0.0002 |
| `model.prediction_calibration.predicted_4_0_to_5_0.ratio` | 0.9629 | 0.9633 | +0.0004 |
| `model.prediction_calibration.predicted_5_0_to_6_0.actual` | 5.2372 | 5.2547 | +0.0175 |
| `model.prediction_calibration.predicted_5_0_to_6_0.predicted` | 5.4322 | 5.4370 | +0.0048 |
| `model.prediction_calibration.predicted_5_0_to_6_0.ratio` | 0.9641 | 0.9665 | +0.0024 |
| `model.prediction_calibration.predicted_6_0_and_above.actual` | 7.0916 | 7.1093 | +0.0177 |
| `model.prediction_calibration.predicted_6_0_and_above.predicted` | 7.3666 | 7.3681 | +0.0015 |
| `model.prediction_calibration.predicted_6_0_and_above.ratio` | 0.9627 | 0.9649 | +0.0022 |
| `model.prediction_calibration.predicted_under_1_0.actual` | 0.8346 | 0.8326 | -0.002 |
| `model.prediction_calibration.predicted_under_1_0.predicted` | 0.6427 | 0.6426 | -0.0001 |
| `model.prediction_calibration.predicted_under_1_0.ratio` | 1.2985 | 1.2956 | -0.0029 |
| `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_points.change_in_absolute_bias` | 0.0279 | 0.0280 | +0.0001 |
| `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_points.change_in_root_mean_square_error` | 0.0000 | 0.0001 | +0.0001 |
| `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | -0.0833 | -0.0813 | +0.002 |
| `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_absolute_bias` | 0.0782 | 0.0785 | +0.0003 |
| `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_error_sd` | 0.0028 | 0.0029 | +0.0001 |
| `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_mean_absolute_error` | -0.0179 | -0.0180 | -0.0001 |
| `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_root_mean_square_error` | 0.0068 | 0.0069 | +0.0001 |
| `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | -0.1614 | -0.1552 | +0.0062 |
| `model.prediction_candidates.candidate_rate_recency_half_life_8_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | 0.0414 | 0.0421 | +0.0007 |
| `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_points.change_in_error_sd` | -0.0012 | -0.0011 | +0.0001 |
| `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_points.change_in_root_mean_square_error` | -0.0000 | 0.0000 | +0 |
| `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | -0.0806 | -0.0786 | +0.002 |
| `model.prediction_candidates.control_directional_minutes_recency_off_expected_goals_assists.change_in_absolute_bias` | 0.0050 | 0.0051 | +0.0001 |
| `model.prediction_candidates.control_directional_minutes_recency_off_minutes.change_in_absolute_bias` | 3.1462 | 3.1276 | -0.0186 |
| `model.prediction_candidates.control_directional_minutes_recency_off_minutes.change_in_error_sd` | 4.0415 | 4.0374 | -0.0041 |
| `model.prediction_candidates.control_directional_minutes_recency_off_minutes.change_in_mean_absolute_error` | 3.9033 | 3.8908 | -0.0125 |
| `model.prediction_candidates.control_directional_minutes_recency_off_minutes.change_in_root_mean_square_error` | 4.2358 | 4.2311 | -0.0047 |
| `model.prediction_candidates.control_directional_minutes_recency_off_points.change_in_absolute_bias` | 0.1149 | 0.1143 | -0.0006 |
| `model.prediction_candidates.control_directional_minutes_recency_off_points.change_in_error_sd` | 0.0716 | 0.0715 | -0.0001 |
| `model.prediction_candidates.control_directional_minutes_recency_off_points.change_in_mean_absolute_error` | 0.0414 | 0.0415 | +0.0001 |
| `model.prediction_candidates.control_directional_minutes_recency_off_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | 0.0401 | 0.0412 | +0.0011 |
| `model.prediction_ordering.model.mean_within_gameweek_rank_correlation` | 0.4378 | 0.4376 | -0.0002 |
| `model.prediction_ordering.model.signed_error_over_the_top_20_predicted` | 0.2372 | 0.2303 | -0.0069 |
| `model.transfer_error.asymmetry_buy_minus_sell.mean` | 0.4097 | 0.3911 | -0.0186 |
| `model.transfer_error.asymmetry_buy_minus_sell.median` | 0.1897 | 0.1759 | -0.0138 |
| `model.transfer_error.buy_side_player_bought.mean` | 0.0411 | 0.0116 | -0.0295 |
| `model.transfer_error.buy_side_player_bought.median` | -0.2115 | -0.2317 | -0.0202 |
| `model.transfer_error.sell_error_sold_player_never_played_again.median` | -2.4297 | -2.4942 | -0.0645 |
| `model.transfer_error.sell_error_sold_player_played_again.median` | -0.2306 | -0.3140 | -0.0834 |
| `model.transfer_error.sell_side_player_sold.mean` | -0.3686 | -0.3795 | -0.0109 |
| `model.transfer_error.sell_side_player_sold.median` | -0.4012 | -0.4077 | -0.0065 |
| `stamp.commit` | eb78ef08e79d | 66fb97159a8e | — |
...
See `stats/README.md` for the full recipe and the runtimes. In short: run a sweep with `FPL_CELLS` set, which writes its own provenance; run the calibration diagnostics with `FPL_MODEL_CSV` set; then `armband snapshot`, which invokes the R inference and renders this file.

**Constants in force at the sweeps above** are recorded in the provenance sidecar beside the cells file, not inlined here — there are over a hundred of them and the fingerprint is what a reader needs. `armband snapshot --constants` prints the full list for a fingerprint.
