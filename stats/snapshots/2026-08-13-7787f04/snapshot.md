...
| | |
|---|---|
| snapshot taken | 2026-08-13 23:09 EDT |
| commit | `7787f0490708` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| branch | `worktree-prior-half-life-on-repaired-xgc` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/0590839a/tmp/model3.csv` |
...
Compared against `2026-08-13-d93d476`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | d93d476a1e96 | 7787f0490708 | — |
