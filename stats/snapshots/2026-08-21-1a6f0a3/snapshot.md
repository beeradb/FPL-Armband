...
| | |
|---|---|
| snapshot taken | 2026-08-21 17:20 EDT |
| commit | `1a6f0a31b93c` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/f51399d1/tmp/model.csv` |
...
Compared against `2026-08-21-95c3072`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 95c307275d0d | 1a6f0a31b93c | — |
