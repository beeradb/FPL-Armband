...
| | |
|---|---|
| snapshot taken | 2026-08-15 14:27 EDT |
| commit | `0485f4e9bfb0` |
| branch | `xpoints-scaled-gate-rerun` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-gaterun.csv` |
...
Compared against `2026-08-15-497b1b2`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 497b1b20e2e5 | 0485f4e9bfb0 | — |
