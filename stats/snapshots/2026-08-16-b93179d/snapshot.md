...
| | |
|---|---|
| snapshot taken | 2026-08-16 01:08 EDT |
| commit | `b93179d2770a` |
| branch | `clean-sheet-mechanism-reconciliation` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-b93179d.csv` |
...
Compared against `2026-08-15-fc40415`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | fc404156958e | b93179d2770a | — |
