...
| | |
|---|---|
| snapshot taken | 2026-08-16 14:27 EDT |
| commit | `e1941eeabffe` |
| branch | `worktree-move-the-resident-index-to-agents-md` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-agentsmd.csv` |
...
Compared against `2026-08-16-edb1bec`.
...
| `stamp.commit` | edb1bec4d500 | e1941eeabffe | — |
...
- `sweep.MINHL#1.commit` was edb1bec4d500
