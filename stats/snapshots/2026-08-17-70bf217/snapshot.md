...
| | |
|---|---|
| snapshot taken | 2026-08-17 09:47 EDT |
| commit | `70bf21720f42` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/banking-diag-model.csv` |
...
Compared against `2026-08-17-32b66c3`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 32b66c35bcab | 70bf21720f42 | — |
