...
| | |
|---|---|
| snapshot taken | 2026-08-12 16:21 EDT |
| commit | `d4ded11003c5` |
| branch | `decision-metric-experiment` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/5ac0c3b1/tmp/model3.csv` |
...
Compared against `2026-08-12-a3fc75a`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | a3fc75ad03ad | d4ded11003c5 | — |
