...
| | |
|---|---|
| snapshot taken | 2026-08-22 17:30 EDT |
| commit | `10d1880053c3` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/40ad330f/tmp/model.csv` |
...
Compared against `2026-08-22-cc029aa`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | cc029aaf8319 | 10d1880053c3 | — |
