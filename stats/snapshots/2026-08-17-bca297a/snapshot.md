...
| | |
|---|---|
| snapshot taken | 2026-08-17 23:16 EDT |
| commit | `bca297aeb59a` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| cells file | `not supplied` |
| model file | `/tmp/wv-model.csv` |
...
Compared against `2026-08-17-2e3173e`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 2e3173e83dae | bca297aeb59a | — |
