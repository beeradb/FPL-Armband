...
| | |
|---|---|
| snapshot taken | 2026-08-22 02:34 EDT |
| commit | `eb78ef08e79d` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| cells file | `not supplied` |
| model file | `/tmp/model-fix-minutes-override.csv` |
...
Compared against `2026-08-22-cb1be17`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | cb1be1762e54 | eb78ef08e79d | — |
