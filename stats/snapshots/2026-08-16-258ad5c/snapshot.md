...
| | |
|---|---|
| snapshot taken | 2026-08-16 15:43 EDT |
| commit | `258ad5ca957e` |
| branch | `engine-season-rules-and-unknown-position-guard` |
| cells file | `not supplied` |
| model file | `/tmp/engrules-model.csv` |
...
- Taken for the engine scoring-rules pin (branch engine-season-rules-and-unknown-position-guard). No sweep cells: this change's confinement ran as TestDiagEngineSeasonRules over 72 cells rather than through the cells file, and its counts are in reviews/2026-08-16-the-engine-scoring-rules-pin/.
- Data state: shipped defaults. FPL_NO_SEASON_SCORING_RULES and FPL_NO_UNPRICED_POSITION_GUARD are both unset and both are new in this commit; a snapshot taken with either set would have been fingerprinted as shipped before they were added to envSwitches, which is the defect this series exists to prevent.
...
Compared against `2026-08-16-db82ab0`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `model.calibration_drift.model_built_through_gw28.predicted` | 3.0450 | 3.0449 | -0.0001 |
| `model.calibration_drift.model_built_through_gw8.ratio` | 0.9428 | 0.9429 | +0.0001 |
| `model.prediction_calibration.predicted_2_0_to_3_0.actual` | 2.5808 | 2.5806 | -0.0002 |
| `model.prediction_calibration.predicted_2_0_to_3_0.predicted` | 2.4882 | 2.4883 | +0.0001 |
| `model.prediction_calibration.predicted_2_0_to_3_0.ratio` | 1.0372 | 1.0371 | -0.0001 |
| `model.prediction_calibration.predicted_3_0_to_4_0.actual` | 3.5011 | 3.5015 | +0.0004 |
| `model.prediction_calibration.predicted_3_0_to_4_0.ratio` | 1.0246 | 1.0248 | +0.0002 |
| `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | -0.0838 | -0.0833 | +0.0005 |
| `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | -0.1639 | -0.1614 | +0.0025 |
| `model.prediction_candidates.candidate_rate_recency_half_life_8_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | 0.0382 | 0.0414 | +0.0032 |
| `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | -0.0811 | -0.0806 | +0.0005 |
| `model.prediction_candidates.control_directional_minutes_recency_off_tail_and_ordering.change_in_signed_error_over_the_top_predicted` | 0.0395 | 0.0401 | +0.0006 |
| `model.prediction_ordering.model.signed_error_over_the_top_20_predicted` | 0.2377 | 0.2372 | -0.0005 |
| `stamp.commit` | db82ab0deb0c | 258ad5ca957e | — |
