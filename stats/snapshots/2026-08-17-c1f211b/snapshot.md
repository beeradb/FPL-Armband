...
| | |
|---|---|
| snapshot taken | 2026-08-17 01:47 EDT |
| commit | `c1f211b763c6` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model-snap.csv` |
...
Compared against `2026-08-16-c6fa9c4`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | c6fa9c4cf5e5 | c1f211b763c6 | — |
