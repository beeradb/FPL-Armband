...
| | |
|---|---|
| snapshot taken | 2026-08-16 16:15 EDT |
| commit | `a6bdb6a679e8` |
| branch | `worktree-rename-the-project-to-armband` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-rename.csv` |
...
Compared against `2026-08-16-bcd0ffc`.
...
| `stamp.commit` | bcd0ffce4344 | a6bdb6a679e8 | — |
...
- `harness.minhl_1.mde_season.policy.flat_no_recency.clustered` was 139
- `harness.minhl_1.mde_season.policy.flat_no_recency.startfixed` was 39
- `harness.minhl_1.mde_season.policy.half_life_2.clustered` was 100
- `harness.minhl_1.mde_season.policy.half_life_2.startfixed` was 46
- `harness.minhl_1.mde_season.policy.half_life_8.clustered` was 65
- `harness.minhl_1.mde_season.policy.half_life_8.startfixed` was 50
- `harness.minhl_1.mde_season.policy.half_life_20.clustered` was 92
- `harness.minhl_1.mde_season.policy.half_life_20.startfixed` was 46
- `harness.minhl_1.mde_season.policy` was 102
- `harness.minhl_1.sig_season.policy` was 75
- `harness.minhl_1.estimator.policy` was season-clustered (primary)
- `harness.minhl_1.df.policy` was 5
- `harness.minhl_1.mde_season.hold.flat_no_recency.clustered` was 65
- `harness.minhl_1.mde_season.hold.flat_no_recency.startfixed` was 50
- `harness.minhl_1.mde_season.hold.half_life_2.clustered` was 62
- `harness.minhl_1.mde_season.hold.half_life_2.startfixed` was 46
- `harness.minhl_1.mde_season.hold.half_life_8.clustered` was 37
- `harness.minhl_1.mde_season.hold.half_life_8.startfixed` was 43
- `harness.minhl_1.mde_season.hold.half_life_20.clustered` was 48
- `harness.minhl_1.mde_season.hold.half_life_20.startfixed` was 53
- `harness.minhl_1.mde_season.hold` was 48
- `harness.minhl_1.sig_season.hold` was 34
- `harness.minhl_1.estimator.hold` was start fixed, no season effect
- `harness.minhl_1.df.hold` was 25
- `harness.minhl_1.mde_season.hold_fixedcap.flat_no_recency.clustered` was 65
- `harness.minhl_1.mde_season.hold_fixedcap.flat_no_recency.startfixed` was 58
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_2.clustered` was 59
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_2.startfixed` was 45
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_8.clustered` was 24
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_8.startfixed` was 41
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_20.clustered` was 47
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_20.startfixed` was 52
- `harness.minhl_1.mde_season.hold_fixedcap` was 49
- `harness.minhl_1.sig_season.hold_fixedcap` was 35
- `harness.minhl_1.estimator.hold_fixedcap` was start fixed, no season effect
- `harness.minhl_1.df.hold_fixedcap` was 25
- `harness.minhl_1.mde_season.hold_nocap.flat_no_recency.clustered` was 67
- `harness.minhl_1.mde_season.hold_nocap.flat_no_recency.startfixed` was 52
- `harness.minhl_1.mde_season.hold_nocap.half_life_2.clustered` was 59
- `harness.minhl_1.mde_season.hold_nocap.half_life_2.startfixed` was 45
- `harness.minhl_1.mde_season.hold_nocap.half_life_8.clustered` was 26
- `harness.minhl_1.mde_season.hold_nocap.half_life_8.startfixed` was 41
- `harness.minhl_1.mde_season.hold_nocap.half_life_20.clustered` was 48
- `harness.minhl_1.mde_season.hold_nocap.half_life_20.startfixed` was 49
- `harness.minhl_1.mde_season.hold_nocap` was 47
- `harness.minhl_1.sig_season.hold_nocap` was 33
- `harness.minhl_1.estimator.hold_nocap` was start fixed, no season effect
- `harness.minhl_1.df.hold_nocap` was 25
- `harness.mde_season.finest` was 24
- `harness.mde_season.coarsest` was 139
- `sweep.MINHL#1.digest` was 67455aaa8835
- `sweep.MINHL#1.commit` was 5d7ce0cec256
- `sweep.MINHL#1.seasons` was 2020-21 2021-22 2022-23 2023-24 2024-25 2025-26
...
- `sweep.MINHL#1.invariance_differs.hold_hold_the_opening_fifteen_never_transfer` was 136
- `sweep.MINHL#1.invariance_differs.nobody_doubled_hold_with_no_captain_at_all` was 117
- `harness.minhl_1.sd_season.policy` was 1.597
- `harness.minhl_1.sd_resid.policy` was 2.464
- `harness.minhl_1.share_season.policy` was 72
- `harness.minhl_1.sd_season.hold` was 0.000
- `harness.minhl_1.sd_resid.hold` was 2.618
- `harness.minhl_1.share_season.hold` was 0
- `harness.minhl_1.sd_season.hold_fixedcap` was 0.000
- `harness.minhl_1.sd_resid.hold_fixedcap` was 2.676
- `harness.minhl_1.share_season.hold_fixedcap` was 0
- `harness.minhl_1.sd_season.hold_nocap` was 0.000
- `harness.minhl_1.sd_resid.hold_nocap` was 2.534
- `harness.minhl_1.share_season.hold_nocap` was 0
