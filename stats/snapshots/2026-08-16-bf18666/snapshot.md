...
| | |
|---|---|
| snapshot taken | 2026-08-16 01:44 EDT |
| commit | `bf186662b15c` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| branch | `transfer-gate-bar-and-anti-residual` |
| cells file | `not supplied` |
| model file | `/tmp/model-final.csv` |
...
|---|---:|---:|---:|
| `stamp.commit` | b93179d2770a | bf186662b15c | — |
