...
| | |
|---|---|
| snapshot taken | 2026-08-12 11:18 EDT |
| commit | `9b2ecb673f69` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| branch | `prior-blend-gate` |
| cells file | `not supplied` |
| model file | `/tmp/model-gate.csv` |
...
| forwards, lowest third by defcon rate | 8 | 2.189 | 0 | 0.664 | 0.664 | 0.631 |
| forwards, middle by defcon rate | 8 | 3.663 | 0.001 | 1.286 | 1.287 | 0.578 |
| forwards, highest third by defcon rate | 8 | 4.731 | 0.008 | 0.899 | 0.907 | 0.594 |
...
Compared against `2026-08-12-705897c`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `model.defcon_bias.defenders_highest_third_by_defcon_rate.bias` | -0.3105 | 0.0693 | +0.3798 |
| `model.defcon_bias.defenders_highest_third_by_defcon_rate.bias_plus_term` | 0.7445 | 0.6096 | -0.1349 |
| `model.defcon_bias.defenders_highest_third_by_defcon_rate.bonus_per_90` | 0.2777 | 0.2231 | -0.0546 |
| `model.defcon_bias.defenders_highest_third_by_defcon_rate.defcon_actions_per_90` | 9.9459 | 7.8328 | -2.1131 |
| `model.defcon_bias.defenders_highest_third_by_defcon_rate.term` | 1.0551 | 0.5403 | -0.5148 |
| `model.defcon_bias.defenders_lowest_third_by_defcon_rate.bias` | 0.2344 | 0.3344 | +0.1 |
| `model.defcon_bias.defenders_lowest_third_by_defcon_rate.bias_plus_term` | 0.3876 | 0.3498 | -0.0378 |
| `model.defcon_bias.defenders_lowest_third_by_defcon_rate.bonus_per_90` | 0.2075 | 0.1980 | -0.0095 |
| `model.defcon_bias.defenders_lowest_third_by_defcon_rate.defcon_actions_per_90` | 5.6688 | 3.6667 | -2.0021 |
| `model.defcon_bias.defenders_lowest_third_by_defcon_rate.term` | 0.1532 | 0.0154 | -0.1378 |
| `model.defcon_bias.defenders_middle_by_defcon_rate.bias` | 0.2128 | 0.3298 | +0.117 |
| `model.defcon_bias.defenders_middle_by_defcon_rate.bias_plus_term` | 0.6795 | 0.4191 | -0.2604 |
| `model.defcon_bias.defenders_middle_by_defcon_rate.bonus_per_90` | 0.2062 | 0.2481 | +0.0419 |
| `model.defcon_bias.defenders_middle_by_defcon_rate.defcon_actions_per_90` | 7.5567 | 5.2237 | -2.333 |
| `model.defcon_bias.defenders_middle_by_defcon_rate.term` | 0.4667 | 0.0893 | -0.3774 |
| `model.defcon_bias.forwards_highest_third_by_defcon_rate.bias` | 1.2361 | 0.8988 | -0.3373 |
| `model.defcon_bias.forwards_highest_third_by_defcon_rate.bias_plus_term` | 1.2740 | 0.9072 | -0.3668 |
| `model.defcon_bias.forwards_highest_third_by_defcon_rate.bonus_per_90` | 0.6122 | 0.5938 | -0.0184 |
| `model.defcon_bias.forwards_highest_third_by_defcon_rate.defcon_actions_per_90` | 5.7601 | 4.7312 | -1.0289 |
| `model.defcon_bias.forwards_highest_third_by_defcon_rate.term` | 0.0379 | 0.0084 | -0.0295 |
| `model.defcon_bias.forwards_lowest_third_by_defcon_rate.bias` | 0.5841 | 0.6640 | +0.0799 |
| `model.defcon_bias.forwards_lowest_third_by_defcon_rate.bias_plus_term` | 0.5844 | 0.6640 | +0.0796 |
| `model.defcon_bias.forwards_lowest_third_by_defcon_rate.bonus_per_90` | 0.5773 | 0.6315 | +0.0542 |
| `model.defcon_bias.forwards_lowest_third_by_defcon_rate.defcon_actions_per_90` | 3.1778 | 2.1891 | -0.9887 |
| `model.defcon_bias.forwards_lowest_third_by_defcon_rate.term` | 0.0003 | 0.0000 | -0.0003 |
| `model.defcon_bias.forwards_middle_by_defcon_rate.bias` | 1.0197 | 1.2860 | +0.2663 |
| `model.defcon_bias.forwards_middle_by_defcon_rate.bias_plus_term` | 1.0258 | 1.2872 | +0.2614 |
| `model.defcon_bias.forwards_middle_by_defcon_rate.bonus_per_90` | 0.5918 | 0.5778 | -0.014 |
| `model.defcon_bias.forwards_middle_by_defcon_rate.defcon_actions_per_90` | 4.5397 | 3.6632 | -0.8765 |
| `model.defcon_bias.forwards_middle_by_defcon_rate.term` | 0.0061 | 0.0012 | -0.0049 |
| `model.defcon_bias.midfielders_highest_third_by_defcon_rate.bias` | 0.0610 | 0.7423 | +0.6813 |
| `model.defcon_bias.midfielders_highest_third_by_defcon_rate.bias_plus_term` | 0.9692 | 1.0416 | +0.0724 |
| `model.defcon_bias.midfielders_highest_third_by_defcon_rate.bonus_per_90` | 0.2866 | 0.3008 | +0.0142 |
| `model.defcon_bias.midfielders_highest_third_by_defcon_rate.defcon_actions_per_90` | 11.3068 | 8.2879 | -3.0189 |
| `model.defcon_bias.midfielders_highest_third_by_defcon_rate.term` | 0.9082 | 0.2993 | -0.6089 |
| `model.defcon_bias.midfielders_lowest_third_by_defcon_rate.bias` | 0.1680 | -0.0042 | -0.1722 |
| `model.defcon_bias.midfielders_lowest_third_by_defcon_rate.bias_plus_term` | 0.2156 | -0.0024 | -0.218 |
| `model.defcon_bias.midfielders_lowest_third_by_defcon_rate.bonus_per_90` | 0.3745 | 0.4014 | +0.0269 |
| `model.defcon_bias.midfielders_lowest_third_by_defcon_rate.defcon_actions_per_90` | 5.7524 | 3.5368 | -2.2156 |
| `model.defcon_bias.midfielders_lowest_third_by_defcon_rate.term` | 0.0476 | 0.0018 | -0.0458 |
| `model.defcon_bias.midfielders_middle_by_defcon_rate.bias` | 0.0989 | 0.4423 | +0.3434 |
| `model.defcon_bias.midfielders_middle_by_defcon_rate.bias_plus_term` | 0.3997 | 0.4767 | +0.077 |
| `model.defcon_bias.midfielders_middle_by_defcon_rate.bonus_per_90` | 0.3300 | 0.3034 | -0.0266 |
| `model.defcon_bias.midfielders_middle_by_defcon_rate.defcon_actions_per_90` | 8.4177 | 5.7228 | -2.6949 |
| `model.defcon_bias.midfielders_middle_by_defcon_rate.term` | 0.3009 | 0.0344 | -0.2665 |
| `stamp.commit` | 705897c2416b | 9b2ecb673f69 | — |
