...
| | |
|---|---|
| snapshot taken | 2026-08-15 22:43 EDT |
| commit | `fc404156958e` |
| branch | `clean-sheet-mechanism-reconciliation` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-cleansheet.csv` |
...
Compared against `2026-08-15-ecebfcc`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | ecebfcc8f3be | fc404156958e | — |
