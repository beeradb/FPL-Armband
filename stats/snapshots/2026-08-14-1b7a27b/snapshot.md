...
| | |
|---|---|
| snapshot taken | 2026-08-14 09:57 EDT |
| commit | `1b7a27bb8b68` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| branch | `prior-zero-guard` |
| cells file | `not supplied` |
| model file | `/tmp/model-1b7a27b.csv` |
...
Compared against `2026-08-14-3c2af85`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 3c2af853e68a | 1b7a27bb8b68 | — |
