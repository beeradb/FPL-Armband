...
| | |
|---|---|
| snapshot taken | 2026-08-22 12:12 EDT |
| commit | `c317e90877e2` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/fae92e65/tmp/model3.csv` |
...
Compared against `2026-08-22-3d3170d`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 3d3170d11297 | c317e90877e2 | — |
