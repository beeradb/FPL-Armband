...
| | |
|---|---|
| snapshot taken | 2026-08-14 08:16 EDT |
| commit | `3c2af853e68a` |
| branch | `worktree-prior-half-life-on-repaired-xgc` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/0590839a/tmp/model-full.csv` |
...
Compared against `2026-08-14-736fd37`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 736fd3741e72 | 3c2af853e68a | — |
