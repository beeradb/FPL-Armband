...
| | |
|---|---|
| snapshot taken | 2026-08-16 14:34 EDT |
| commit | `83cdabf609fb` |
| branch | `integrate-the-engine-scale-exposure` |
| cells file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/cells3.csv` |
| model file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model3.csv` |
| inference for MINHL#1 | `stats/out/cells3` |
...
- the model CSV /home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model3.csv holds 8 runs (newest 1786904339-2092311 wins per figure). It appends and its path is outside the repo, so confirm every run in it came from this commit — a stale run from another branch is how 2026-08-15-9e743cf shipped pre-fix clean-sheet figures under a commit that had the fix

### Sweep `MINHL#1`

| | |
|---|---|
| ran at commit | `d8d0b9ea2f7c` |
...
|---|---:|---:|---:|
| `stamp.commit` | edb1bec4d500 | 83cdabf609fb | — |
| `sweep.MINHL#1.commit` | edb1bec4d500 | d8d0b9ea2f7c | — |
