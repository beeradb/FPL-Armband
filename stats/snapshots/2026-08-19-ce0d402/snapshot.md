...
| | |
|---|---|
| snapshot taken | 2026-08-19 20:58 EDT |
| commit | `ce0d40216b92` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/fae92e65/tmp/model4.csv` |
...
Compared against `2026-08-19-ac66f3a`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | ac66f3a06405 | ce0d40216b92 | — |
