...
| | |
|---|---|
| snapshot taken | 2026-08-22 09:17 EDT |
| commit | `2aa434643422` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/fae92e65/tmp/model.csv` |
...
- the model CSV /home/bbowman.guest/.claude/jobs/fae92e65/tmp/model.csv holds 2 runs (newest 1787404589-2478998 wins per figure). It appends and its path is outside the repo, so confirm every run in it came from this commit — a stale run from another branch is how 2026-08-15-9e743cf shipped pre-fix clean-sheet figures under a commit that had the fix
...
Compared against `2026-08-22-66fb971`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 66fb97159a8e | 2aa434643422 | — |
