...
| | |
|---|---|
| snapshot taken | 2026-08-16 15:00 EDT |
| commit | `bcd0ffce4344` |
| branch | `integrate-the-engine-scale-exposure` |
| cells file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/cells4.csv` |
| model file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model4.csv` |
| inference for MINHL#1 | `stats/out/cells4` |
...
- the model CSV /home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model4.csv holds 8 runs (newest 1786905978-2114459 wins per figure). It appends and its path is outside the repo, so confirm every run in it came from this commit — a stale run from another branch is how 2026-08-15-9e743cf shipped pre-fix clean-sheet figures under a commit that had the fix

### Sweep `MINHL#1`

| | |
|---|---|
| ran at commit | `5d7ce0cec256` |
...
Compared against `2026-08-16-83cdabf`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 83cdabf609fb | bcd0ffce4344 | — |
| `sweep.MINHL#1.commit` | d8d0b9ea2f7c | 5d7ce0cec256 | — |
