...
| | |
|---|---|
| snapshot taken | 2026-08-18 18:51 EDT |
| commit | `b75f0748d689` — **working tree was dirty**, so this commit alone does not identify the code that ran |
...
Compared against `2026-08-18-154bc80`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 154bc800b023 | b75f0748d689 | — |
