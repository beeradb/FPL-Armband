...
| | |
|---|---|
| snapshot taken | 2026-08-15 13:40 EDT |
| commit | `497b1b20e2e5` |
| branch | `worktree-closed-line-same-club-bonus` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model-sameclub.csv` |
...
Compared against `2026-08-15-7cbe87f`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 7cbe87f3edc5 | 497b1b20e2e5 | — |
