...
| | |
|---|---|
| snapshot taken | 2026-08-19 16:40 EDT |
| commit | `5e64cee21f20` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/tmp/model-planner.csv` |
...
Compared against `2026-08-19-f146ced`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | f146ced79ca7 | 5e64cee21f20 | — |
