...
| | |
|---|---|
| snapshot taken | 2026-08-14 23:10 EDT |
| commit | `862c86afe3c1` |
...
- Comment-only change in internal/analysis since the previous snapshot (seven -> eight in a count of duplicated config lists). No figure can move; this retake exists because the staleness guard cannot distinguish a comment from code, which is the right side to err on.
- The clean-sheet block still corrects main's 84a0945, which banks n=2955/error 0.0592 while the code at that commit produces n=2870/0.0698. 2955 is the pre-guard sample; no snapshot since 7f33270 re-ran that diagnostic.
...
Compared against `2026-08-14-5a70915`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 5a7091564ccb | 862c86afe3c1 | — |
