...
| | |
|---|---|
| snapshot taken | 2026-08-16 04:29 EDT |
| commit | `7fa6de7b9280` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| branch | `xgc-transport-tercile-cancellation` |
| cells file | `not supplied` |
| model file | `/tmp/model-xgc-f2.csv` |
...
|---|---:|---:|---:|
| `stamp.commit` | b93179d2770a | 7fa6de7b9280 | — |
