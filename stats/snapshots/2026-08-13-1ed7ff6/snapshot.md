...
| | |
|---|---|
| snapshot taken | 2026-08-13 13:58 EDT |
| commit | `1ed7ff69ce82` |
| branch | `worktree-prior-half-life-on-repaired-xgc` |
| cells file | `/home/bbowman.guest/fpl/.claude/worktrees/prior-half-life-on-repaired-xgc/stats/snapshots/2026-08-13-aa95f75/cells/6s-minhl.csv` |
| model file | `/home/bbowman.guest/.claude/jobs/0590839a/tmp/model.csv` |
...
Compared against `2026-08-13-5edf13c`.
...
| `stamp.commit` | 5edf13cf7548 | 1ed7ff69ce82 | — |
...
- `sweep.MINHL#1.commit` = b400ec37f09e
...
- `model.transfer_error.buy_side_player_bought.median` = -0.2559
- `model.transfer_error.buy_side_player_bought.mean` = -0.0524
- `model.transfer_error.sell_side_player_sold.median` = -0.3032
- `model.transfer_error.sell_side_player_sold.mean` = -0.2437
- `model.transfer_error.asymmetry_buy_minus_sell.median` = 0.0474
- `model.transfer_error.asymmetry_buy_minus_sell.mean` = 0.1913
- `model.transfer_error.sell_error_sold_player_played_again.median` = -0.1531
- `model.transfer_error.sell_error_sold_player_never_played_again.median` = -2.4739
