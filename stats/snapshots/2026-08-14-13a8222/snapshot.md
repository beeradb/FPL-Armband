...
| | |
|---|---|
| snapshot taken | 2026-08-14 11:32 EDT |
| commit | `13a822206c5a` |
...
Compared against `2026-08-14-1b7a27b`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `model.transfer_error.asymmetry_buy_minus_sell.median` | 0.0474 | 0.0469 | -0.0005 |
| `model.transfer_error.buy_side_player_bought.median` | -0.2559 | -0.2577 | -0.0018 |
| `model.transfer_error.sell_side_player_sold.median` | -0.3032 | -0.3046 | -0.0014 |
| `stamp.commit` | 1b7a27bb8b68 | 13a822206c5a | — |
