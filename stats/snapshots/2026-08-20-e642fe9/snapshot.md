...
| | |
|---|---|
| snapshot taken | 2026-08-20 09:08 EDT |
| commit | `e642fe9ed668` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| cells file | `not supplied` |
| model file | `/tmp/model-review-copy.csv` |
...
Compared against `2026-08-19-ce0d402`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | ce0d40216b92 | e642fe9ed668 | — |
