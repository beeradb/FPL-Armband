...
| | |
|---|---|
| snapshot taken | 2026-08-14 15:19 EDT |
| commit | `6a75a6561786` |
| branch | `worktree-prior-defcon-projection` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/0590839a/tmp/model5.csv` |
...
Compared against `2026-08-14-cff7260`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | cff726036aed | 6a75a6561786 | — |
