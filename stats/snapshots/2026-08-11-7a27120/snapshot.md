...
| | |
|---|---|
| snapshot taken | 2026-08-11 00:09 EDT |
| commit | `7a271205ec64` |
...
Compared against `2026-08-10-13cded0`.
...
| `stamp.commit` | 13cded07a00a | 7a271205ec64 | — |
...
- `harness.oracleminutes_1.mde_season.policy.oracle_info_availability_never_played_at_all.clustered` was 39
- `harness.oracleminutes_1.mde_season.policy.oracle_info_availability_never_played_at_all.startfixed` was 40
- `harness.oracleminutes_1.mde_season.policy.oracle_info_lineups_perfect_lineups.clustered` was 182
- `harness.oracleminutes_1.mde_season.policy.oracle_info_lineups_perfect_lineups.startfixed` was 42
- `harness.oracleminutes_1.mde_season.policy.oracle_info_minutes_perfect_minutes.clustered` was 168
- `harness.oracleminutes_1.mde_season.policy.oracle_info_minutes_perfect_minutes.startfixed` was 60
- `harness.oracleminutes_1.mde_season.policy.oracle_info_minutes_season_average_window.clustered` was 140
- `harness.oracleminutes_1.mde_season.policy.oracle_info_minutes_season_average_window.startfixed` was 70
- `harness.oracleminutes_1.mde_season.policy` was 143
- `harness.oracleminutes_1.sig_season.policy` was 110
- `harness.oracleminutes_1.estimator.policy` was season-clustered (primary)
- `harness.oracleminutes_1.df.policy` was 3
- `harness.oracleminutes_1.mde_season.hold.oracle_info_availability_never_played_at_all.clustered` was 19
- `harness.oracleminutes_1.mde_season.hold.oracle_info_availability_never_played_at_all.startfixed` was 17
- `harness.oracleminutes_1.mde_season.hold.oracle_info_lineups_perfect_lineups.clustered` was 231
- `harness.oracleminutes_1.mde_season.hold.oracle_info_lineups_perfect_lineups.startfixed` was 93
- `harness.oracleminutes_1.mde_season.hold.oracle_info_minutes_perfect_minutes.clustered` was 312
- `harness.oracleminutes_1.mde_season.hold.oracle_info_minutes_perfect_minutes.startfixed` was 108
- `harness.oracleminutes_1.mde_season.hold.oracle_info_minutes_season_average_window.clustered` was 177
- `harness.oracleminutes_1.mde_season.hold.oracle_info_minutes_season_average_window.startfixed` was 98
- `harness.oracleminutes_1.mde_season.hold` was 214
- `harness.oracleminutes_1.sig_season.hold` was 163
- `harness.oracleminutes_1.estimator.hold` was season-clustered (primary)
- `harness.oracleminutes_1.df.hold` was 3
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_availability_never_played_at_all.clustered` was 20
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_availability_never_played_at_all.startfixed` was 18
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_lineups_perfect_lineups.clustered` was 233
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_lineups_perfect_lineups.startfixed` was 98
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_minutes_perfect_minutes.clustered` was 301
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_minutes_perfect_minutes.startfixed` was 113
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_minutes_season_average_window.clustered` was 207
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_minutes_season_average_window.startfixed` was 105
- `harness.oracleminutes_1.mde_season.hold_fixedcap` was 217
- `harness.oracleminutes_1.sig_season.hold_fixedcap` was 166
- `harness.oracleminutes_1.estimator.hold_fixedcap` was season-clustered (primary)
- `harness.oracleminutes_1.df.hold_fixedcap` was 3
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_availability_never_played_at_all.clustered` was 17
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_availability_never_played_at_all.startfixed` was 15
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_lineups_perfect_lineups.clustered` was 224
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_lineups_perfect_lineups.startfixed` was 79
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_minutes_perfect_minutes.clustered` was 299
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_minutes_perfect_minutes.startfixed` was 93
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_minutes_season_average_window.clustered` was 217
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_minutes_season_average_window.startfixed` was 87
- `harness.oracleminutes_1.mde_season.hold_nocap` was 216
- `harness.oracleminutes_1.sig_season.hold_nocap` was 165
- `harness.oracleminutes_1.estimator.hold_nocap` was season-clustered (primary)
- `harness.oracleminutes_1.df.hold_nocap` was 3
- `harness.oracleprices_1.mde_season.policy.oracle_info_prices_perfect_timing.clustered` was 66
- `harness.oracleprices_1.mde_season.policy.oracle_info_prices_perfect_timing.startfixed` was 31
- `harness.oracleprices_1.mde_season.policy` was 31
- `harness.oracleprices_1.sig_season.policy` was 22
- `harness.oracleprices_1.estimator.policy` was start fixed, no season effect
- `harness.oracleprices_1.df.policy` was 15
- `harness.oracleprices_1.invariant.hold` was true
- `harness.oracleprices_1.invariant.hold_fixedcap` was true
- `harness.oracleprices_1.invariant.hold_nocap` was true
- `harness.mde_season.finest` was 17
- `harness.mde_season.coarsest` was 312
- `sweep.ORACLEMINUTES#1.digest` was 78a58b3f4253
- `sweep.ORACLEMINUTES#1.commit` was 9c1a9731b984
- `sweep.ORACLEMINUTES#1.seasons` was 2022-23 2023-24 2024-25 2025-26
- `sweep.ORACLEMINUTES#1.starts` was 1, 6, 11, 16, 21, 26
- `sweep.ORACLEMINUTES#1.arms` was 5
- `sweep.ORACLEMINUTES#1.arms_killed` was 0
- `sweep.ORACLEMINUTES#1.arms_partial` was 0
- `sweep.ORACLEMINUTES#1.invariance_differs.hold_hold_the_opening_fifteen_never_transfer` was 82
- `sweep.ORACLEMINUTES#1.invariance_differs.nobody_doubled_hold_with_no_captain_at_all` was 80
- `sweep.ORACLEPRICES#1.digest` was 78a58b3f4253
- `sweep.ORACLEPRICES#1.commit` was e51a56a66d10
- `sweep.ORACLEPRICES#1.seasons` was 2022-23 2023-24 2024-25 2025-26
- `sweep.ORACLEPRICES#1.starts` was 1, 6, 11, 16, 21, 26
- `sweep.ORACLEPRICES#1.arms` was 2
- `sweep.ORACLEPRICES#1.arms_killed` was 0
- `sweep.ORACLEPRICES#1.arms_partial` was 0
- `sweep.ORACLEPRICES#1.invariance_differs.hold_hold_the_opening_fifteen_never_transfer` was 0
- `sweep.ORACLEPRICES#1.invariance_differs.nobody_doubled_hold_with_no_captain_at_all` was 0
- `harness.oracleminutes_1.sd_season.policy` was 1.539
- `harness.oracleminutes_1.sd_resid.policy` was 2.347
- `harness.oracleminutes_1.share_season.policy` was 72
- `harness.oracleminutes_1.sd_season.hold` was 2.228
- `harness.oracleminutes_1.sd_resid.hold` was 3.741
- `harness.oracleminutes_1.share_season.hold` was 68
- `harness.oracleminutes_1.sd_season.hold_fixedcap` was 2.218
- `harness.oracleminutes_1.sd_resid.hold_fixedcap` was 3.947
- `harness.oracleminutes_1.share_season.hold_fixedcap` was 65
- `harness.oracleminutes_1.sd_season.hold_nocap` was 2.398
- `harness.oracleminutes_1.sd_resid.hold_nocap` was 3.231
- `harness.oracleminutes_1.share_season.hold_nocap` was 77
- `harness.oracleprices_1.sd_season.policy` was 0.620
- `harness.oracleprices_1.sd_resid.policy` was 1.350
- `harness.oracleprices_1.share_season.policy` was 56
