...
| | |
|---|---|
| snapshot taken | 2026-08-20 19:46 EDT |
| commit | `944881eed20e` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/9912b5db/tmp/model2.csv` |
...
Compared against `2026-08-20-fca8833`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | fca883376930 | 944881eed20e | — |
