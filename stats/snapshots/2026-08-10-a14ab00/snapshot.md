...
| | |
|---|---|
| snapshot taken | 2026-08-10 22:11 EDT |
| commit | `a14ab006bc58` |
| branch | `club-error-timescale` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/5340a581/tmp/model.csv` |
...
Compared against `2026-08-10-27740ba`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `harness.mde.present` | true | false | — |
| `model.sixty_minute_threshold.players_averaging_0_10_minutes_a_gameweek.error` | -0.0003 | 0.0062 | +0.0065 |
| `model.sixty_minute_threshold.players_averaging_0_10_minutes_a_gameweek.model_credits` | 0.0063 | 0.0128 | +0.0065 |
| `model.sixty_minute_threshold.players_averaging_10_20_minutes_a_gameweek.error` | -0.0198 | -0.0195 | +0.0003 |
| `model.sixty_minute_threshold.players_averaging_10_20_minutes_a_gameweek.model_credits` | 0.1030 | 0.1032 | +0.0002 |
| `model.sixty_minute_threshold.players_averaging_20_30_minutes_a_gameweek.error` | -0.0253 | -0.0425 | -0.0172 |
| `model.sixty_minute_threshold.players_averaging_20_30_minutes_a_gameweek.model_credits` | 0.2019 | 0.1846 | -0.0173 |
| `model.sixty_minute_threshold.players_averaging_30_40_minutes_a_gameweek.error` | -0.0287 | -0.0344 | -0.0057 |
| `model.sixty_minute_threshold.players_averaging_30_40_minutes_a_gameweek.model_credits` | 0.3060 | 0.3002 | -0.0058 |
| `model.sixty_minute_threshold.players_averaging_40_50_minutes_a_gameweek.error` | -0.0388 | -0.0070 | +0.0318 |
| `model.sixty_minute_threshold.players_averaging_40_50_minutes_a_gameweek.model_credits` | 0.4226 | 0.4544 | +0.0318 |
| `model.sixty_minute_threshold.players_averaging_50_60_minutes_a_gameweek.error` | -0.0331 | 0.0378 | +0.0709 |
| `model.sixty_minute_threshold.players_averaging_50_60_minutes_a_gameweek.model_credits` | 0.5427 | 0.6136 | +0.0709 |
| `model.sixty_minute_threshold.players_averaging_60_70_minutes_a_gameweek.error` | -0.0334 | 0.0500 | +0.0834 |
| `model.sixty_minute_threshold.players_averaging_60_70_minutes_a_gameweek.model_credits` | 0.6667 | 0.7501 | +0.0834 |
| `model.sixty_minute_threshold.players_averaging_70_80_minutes_a_gameweek.error` | -0.0129 | 0.0416 | +0.0545 |
| `model.sixty_minute_threshold.players_averaging_70_80_minutes_a_gameweek.model_credits` | 0.7963 | 0.8509 | +0.0546 |
| `model.sixty_minute_threshold.players_averaging_80_91_minutes_a_gameweek.error` | 0.0132 | 0.0060 | -0.0072 |
| `model.sixty_minute_threshold.players_averaging_80_91_minutes_a_gameweek.model_credits` | 0.9346 | 0.9274 | -0.0072 |
| `stamp.commit` | 27740badc1f0 | a14ab006bc58 | — |
...
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_mean_absolute_error` = -0.0217
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_root_mean_square_error` = -0.0009
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_absolute_bias` = 0.0808
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_points.change_in_error_sd` = -0.0038
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_minutes.change_in_mean_absolute_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_minutes.change_in_root_mean_square_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_minutes.change_in_absolute_bias` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_minutes.change_in_error_sd` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_expected_goals_assists.change_in_mean_absolute_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_expected_goals_assists.change_in_root_mean_square_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_expected_goals_assists.change_in_absolute_bias` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_expected_goals_assists.change_in_error_sd` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_tail_and_ordering.change_in_signed_error_over_the_top_predicted` = -0.1964
- `model.prediction_candidates.candidate_appearance_constants_refit_on_the_windowed_population_tail_and_ordering.change_in_rank_correlation` = -0.0040
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_points.change_in_mean_absolute_error` = -0.0095
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_points.change_in_root_mean_square_error` = -0.0036
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_points.change_in_absolute_bias` = 0.0291
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_points.change_in_error_sd` = -0.0044
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_minutes.change_in_mean_absolute_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_minutes.change_in_root_mean_square_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_minutes.change_in_absolute_bias` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_minutes.change_in_error_sd` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_expected_goals_assists.change_in_mean_absolute_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_expected_goals_assists.change_in_root_mean_square_error` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_expected_goals_assists.change_in_absolute_bias` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_expected_goals_assists.change_in_error_sd` = 0.0000
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_tail_and_ordering.change_in_signed_error_over_the_top_predicted` = -0.1040
- `model.prediction_candidates.candidate_appearance_constants_refit_against_expectedminutes_tail_and_ordering.change_in_rank_correlation` = -0.0006
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_points.change_in_mean_absolute_error` = -0.0092
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_points.change_in_root_mean_square_error` = -0.0036
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_points.change_in_absolute_bias` = 0.0282
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_points.change_in_error_sd` = -0.0044
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_minutes.change_in_mean_absolute_error` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_minutes.change_in_root_mean_square_error` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_minutes.change_in_absolute_bias` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_minutes.change_in_error_sd` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_expected_goals_assists.change_in_mean_absolute_error` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_expected_goals_assists.change_in_root_mean_square_error` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_expected_goals_assists.change_in_absolute_bias` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_expected_goals_assists.change_in_error_sd` = 0.0000
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_tail_and_ordering.change_in_signed_error_over_the_top_predicted` = -0.0998
- `model.prediction_candidates.candidate_the_sixty_minute_curve_alone_refit_against_expectedminutes_tail_and_ordering.change_in_rank_correlation` = -0.0006
- `model.sixty_minute_threshold.players_averaging_0_10_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.0063
- `model.sixty_minute_threshold.players_averaging_10_20_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.1030
- `model.sixty_minute_threshold.players_averaging_20_30_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.2019
- `model.sixty_minute_threshold.players_averaging_30_40_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.3060
- `model.sixty_minute_threshold.players_averaging_40_50_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.4226
- `model.sixty_minute_threshold.players_averaging_50_60_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.5427
- `model.sixty_minute_threshold.players_averaging_60_70_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.6667
- `model.sixty_minute_threshold.players_averaging_70_80_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.7963
- `model.sixty_minute_threshold.players_averaging_80_91_minutes_a_gameweek.the_superseded_minutes_reliability_proxy_credited` = 0.9346
...
- `harness.minhl_1.mde_season.policy.flat_no_recency.clustered` was 271
- `harness.minhl_1.mde_season.policy.flat_no_recency.startfixed` was 56
- `harness.minhl_1.mde_season.policy.half_life_2.clustered` was 74
- `harness.minhl_1.mde_season.policy.half_life_2.startfixed` was 48
- `harness.minhl_1.mde_season.policy.half_life_8.clustered` was 112
- `harness.minhl_1.mde_season.policy.half_life_8.startfixed` was 62
- `harness.minhl_1.mde_season.policy.half_life_20.clustered` was 183
- `harness.minhl_1.mde_season.policy.half_life_20.startfixed` was 71
- `harness.minhl_1.mde_season.policy` was 177
- `harness.minhl_1.sig_season.policy` was 135
- `harness.minhl_1.estimator.policy` was season-clustered (primary)
- `harness.minhl_1.df.policy` was 3
- `harness.minhl_1.mde_season.hold.flat_no_recency.clustered` was 84
- `harness.minhl_1.mde_season.hold.flat_no_recency.startfixed` was 49
- `harness.minhl_1.mde_season.hold.half_life_2.clustered` was 87
- `harness.minhl_1.mde_season.hold.half_life_2.startfixed` was 46
- `harness.minhl_1.mde_season.hold.half_life_8.clustered` was 58
- `harness.minhl_1.mde_season.hold.half_life_8.startfixed` was 39
- `harness.minhl_1.mde_season.hold.half_life_20.clustered` was 88
- `harness.minhl_1.mde_season.hold.half_life_20.startfixed` was 51
- `harness.minhl_1.mde_season.hold` was 47
- `harness.minhl_1.sig_season.hold` was 33
- `harness.minhl_1.estimator.hold` was start fixed, no season effect
- `harness.minhl_1.df.hold` was 15
- `harness.minhl_1.mde_season.hold_fixedcap.flat_no_recency.clustered` was 89
- `harness.minhl_1.mde_season.hold_fixedcap.flat_no_recency.startfixed` was 54
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_2.clustered` was 104
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_2.startfixed` was 45
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_8.clustered` was 44
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_8.startfixed` was 37
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_20.clustered` was 83
- `harness.minhl_1.mde_season.hold_fixedcap.half_life_20.startfixed` was 49
- `harness.minhl_1.mde_season.hold_fixedcap` was 47
- `harness.minhl_1.sig_season.hold_fixedcap` was 33
- `harness.minhl_1.estimator.hold_fixedcap` was start fixed, no season effect
- `harness.minhl_1.df.hold_fixedcap` was 15
- `harness.minhl_1.mde_season.hold_nocap.flat_no_recency.clustered` was 97
- `harness.minhl_1.mde_season.hold_nocap.flat_no_recency.startfixed` was 53
- `harness.minhl_1.mde_season.hold_nocap.half_life_2.clustered` was 97
- `harness.minhl_1.mde_season.hold_nocap.half_life_2.startfixed` was 43
- `harness.minhl_1.mde_season.hold_nocap.half_life_8.clustered` was 44
- `harness.minhl_1.mde_season.hold_nocap.half_life_8.startfixed` was 37
- `harness.minhl_1.mde_season.hold_nocap.half_life_20.clustered` was 81
- `harness.minhl_1.mde_season.hold_nocap.half_life_20.startfixed` was 49
- `harness.minhl_1.mde_season.hold_nocap` was 46
- `harness.minhl_1.sig_season.hold_nocap` was 33
- `harness.minhl_1.estimator.hold_nocap` was start fixed, no season effect
- `harness.minhl_1.df.hold_nocap` was 15
- `harness.mde_season.finest` was 44
- `harness.mde_season.coarsest` was 271
- `sweep.MINHL#1.digest` was ae6ec815e6a5
- `sweep.MINHL#1.commit` was 27740badc1f0
- `sweep.MINHL#1.seasons` was 2022-23 2023-24 2024-25 2025-26
- `sweep.MINHL#1.starts` was 1, 6, 11, 16, 21, 26
- `sweep.MINHL#1.arms` was 5
- `sweep.MINHL#1.arms_killed` was 0
- `sweep.MINHL#1.arms_partial` was 0
- `sweep.MINHL#1.invariance_differs.hold_hold_the_opening_fifteen_never_transfer` was 89
- `sweep.MINHL#1.invariance_differs.nobody_doubled_hold_with_no_captain_at_all` was 73
- `harness.minhl_1.sd_season.policy` was 1.971
- `harness.minhl_1.sd_resid.policy` was 2.572
- `harness.minhl_1.share_season.policy` was 78
- `harness.minhl_1.sd_season.hold` was 0.604
- `harness.minhl_1.sd_resid.hold` was 2.006
- `harness.minhl_1.share_season.hold` was 35
- `harness.minhl_1.sd_season.hold_fixedcap` was 0.657
- `harness.minhl_1.sd_resid.hold_fixedcap` was 2.001
- `harness.minhl_1.share_season.hold_fixedcap` was 39
- `harness.minhl_1.sd_season.hold_nocap` was 0.662
- `harness.minhl_1.sd_resid.hold_nocap` was 1.971
- `harness.minhl_1.share_season.hold_nocap` was 40
- `model.transfer_error.buy_side_player_bought.median` was -0.6086
- `model.transfer_error.buy_side_player_bought.mean` was -0.2783
- `model.transfer_error.sell_side_player_sold.median` was -0.2006
- `model.transfer_error.sell_side_player_sold.mean` was -0.2161
- `model.transfer_error.asymmetry_buy_minus_sell.median` was -0.4080
- `model.transfer_error.asymmetry_buy_minus_sell.mean` was -0.0622
- `model.transfer_error.sell_error_sold_player_played_again.median` was -0.0516
- `model.transfer_error.sell_error_sold_player_never_played_again.median` was -2.4739
