...
| | |
|---|---|
| snapshot taken | 2026-08-12 15:05 EDT |
| commit | `a3fc75ad03ad` |
| branch | `prior-blend-gate` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/5ac0c3b1/tmp/model2.csv` |
...
Compared against `2026-08-12-3c78a6a`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 3c78a6a95ce7 | a3fc75ad03ad | — |
