...
| | |
|---|---|
| snapshot taken | 2026-08-16 02:03 EDT |
| commit | `01ef5b792a8a` |
| branch | `fail-loudly-on-an-unreadable-fixture-scale` |
| cells file | `not supplied` |
| model file | `/tmp/model-fixture-scale-strict.csv` |
...
|---|---:|---:|---:|
| `stamp.commit` | b93179d2770a | 01ef5b792a8a | — |
