...
| | |
|---|---|
| snapshot taken | 2026-08-15 08:38 EDT |
| commit | `e056821b01d1` |
| branch | `list-block-2026-08-15` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-clean.csv` |
...
- Re-rendered after e056821 removed df 3 / t_crit 3.18 from the generated prose. Same single-run model CSV and the same figures as 2026-08-15-a3233c9, which this supersedes; only prose differs.
...
Compared against `2026-08-15-a3233c9`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | a3233c9ac48c | e056821b01d1 | — |
