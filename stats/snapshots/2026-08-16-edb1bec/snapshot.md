...
| | |
|---|---|
| snapshot taken | 2026-08-16 11:53 EDT |
| commit | `edb1bec4d500` |
| branch | `integrate-the-conversion-fit-measurement` |
| cells file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/cells2.csv` |
| model file | `/home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model2.csv` |
| inference for MINHL#1 | `stats/out/cells2` |
...
- the model CSV /home/bbowman.guest/.claude/jobs/e1fd170e/tmp/model2.csv holds 8 runs (newest 1786894828-2008050 wins per figure). It appends and its path is outside the repo, so confirm every run in it came from this commit — a stale run from another branch is how 2026-08-15-9e743cf shipped pre-fix clean-sheet figures under a commit that had the fix

### Sweep `MINHL#1`

| | |
|---|---|
| ran at commit | `edb1bec4d500` |
...
Compared against `2026-08-16-dc8527a`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | dc8527a6685f | edb1bec4d500 | — |
| `sweep.MINHL#1.commit` | 4f67cc92bc48 | edb1bec4d500 | — |
