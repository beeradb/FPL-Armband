...
| | |
|---|---|
| snapshot taken | 2026-08-20 15:33 EDT |
| commit | `3d6fa486561b` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/model-p2.csv` |
...
Compared against `2026-08-20-34bc241`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 34bc241bc6e1 | 3d6fa486561b | — |
