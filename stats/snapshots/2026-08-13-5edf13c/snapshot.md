...
| | |
|---|---|
| snapshot taken | 2026-08-13 12:35 EDT |
| commit | `5edf13cf7548` |
| branch | `worktree-archive-data-repairs` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model3.csv` |
...
Compared against `2026-08-13-594dcfc`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 594dcfcc0b2f | 5edf13cf7548 | — |
