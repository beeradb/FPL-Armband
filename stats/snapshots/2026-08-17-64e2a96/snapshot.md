...
| | |
|---|---|
| snapshot taken | 2026-08-17 13:48 EDT |
| commit | `64e2a9633e28` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/optionvalue-model.csv` |
...
*Population: 521 moves judged, 6 seasons x 3 start points, min_gain 0.40.*

| | n | median | mean |
|---|---:|---:|---:|
| buy side (player bought) | 521 | -0.212 | 0.041 |
| sell side (player sold) | 521 | -0.401 | -0.369 |
| asymmetry (buy minus sell) | 521 | 0.19 | 0.41 |
| sell error: sold player played again | 448 | -0.231 | — |
| sell error: sold player never played again | 73 | -2.43 | — |
...
Compared against `2026-08-17-70bf217`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `model.transfer_error.asymmetry_buy_minus_sell.mean` | 0.1913 | 0.4097 | +0.2184 |
| `model.transfer_error.asymmetry_buy_minus_sell.median` | 0.0469 | 0.1897 | +0.1428 |
| `model.transfer_error.buy_side_player_bought.mean` | -0.0524 | 0.0411 | +0.0935 |
| `model.transfer_error.buy_side_player_bought.median` | -0.2577 | -0.2115 | +0.0462 |
| `model.transfer_error.sell_error_sold_player_never_played_again.median` | -2.4739 | -2.4297 | +0.0442 |
| `model.transfer_error.sell_error_sold_player_played_again.median` | -0.1531 | -0.2306 | -0.0775 |
| `model.transfer_error.sell_side_player_sold.mean` | -0.2437 | -0.3686 | -0.1249 |
| `model.transfer_error.sell_side_player_sold.median` | -0.3046 | -0.4012 | -0.0966 |
| `stamp.commit` | 70bf21720f42 | 64e2a9633e28 | — |
