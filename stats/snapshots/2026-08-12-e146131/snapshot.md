...
| | |
|---|---|
| snapshot taken | 2026-08-12 16:49 EDT |
| commit | `e1461317d9e8` |
| branch | `decision-metric-experiment` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/5ac0c3b1/tmp/model4.csv` |
...
Compared against `2026-08-12-d4ded11`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | d4ded11003c5 | e1461317d9e8 | — |
