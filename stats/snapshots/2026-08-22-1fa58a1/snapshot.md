...
| | |
|---|---|
| snapshot taken | 2026-08-22 09:32 EDT |
| commit | `1fa58a19fcea` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/fae92e65/tmp/model2.csv` |
...
Compared against `2026-08-22-2aa4346`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 2aa434643422 | 1fa58a19fcea | — |
