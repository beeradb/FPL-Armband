...
| | |
|---|---|
| snapshot taken | 2026-08-14 00:32 EDT |
| commit | `736fd3741e72` |
| branch | `chip-stage3-verify` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model2.csv` |
...
Compared against `2026-08-13-6b83b08`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 6b83b0897496 | 736fd3741e72 | — |
