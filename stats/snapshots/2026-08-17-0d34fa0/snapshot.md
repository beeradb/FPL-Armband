...
| | |
|---|---|
| snapshot taken | 2026-08-17 02:58 EDT |
| commit | `0d34fa09f39d` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/banking-snapshot-model.csv` |
...
Compared against `2026-08-17-c1f211b`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | c1f211b763c6 | 0d34fa09f39d | — |
