...
| ORACLEMINUTES#1 | **POLICY** | ORACLE[info:lineups] perfect lineups | 139–182 pts | 30–42 pts | 9.62 | 0.001 |
| ORACLEMINUTES#1 | **POLICY** | ORACLE[info:minutes] perfect minutes | 128–168 pts | 43–60 pts | 4.06 | 0.027 |
| ORACLEMINUTES#1 | **POLICY** | ORACLE[info:minutes] season-average window | 107–140 pts | 50–70 pts | 2.06 | 0.149 |
| ORACLEMINUTES#1 | POLICY | *pooled over the sweep's arms* | 110–143 pts, 3 df | — | — | 0.001 (strictest arm) |
| ORACLEMINUTES#1 | **HOLD** | ORACLE[info:availability] never played at all | 14–19 pts | 12–17 pts | 0.66 | 0.587 |
| ORACLEMINUTES#1 | **HOLD** | ORACLE[info:lineups] perfect lineups | 176–231 pts | 66–93 pts | 3.17 | 0.055 |
| ORACLEMINUTES#1 | **HOLD** | ORACLE[info:minutes] perfect minutes | 239–312 pts | 77–108 pts | 4.36 | 0.021 |
| ORACLEMINUTES#1 | **HOLD** | ORACLE[info:minutes] season-average window | 135–177 pts | 70–98 pts | 1.68 | 0.214 |
| ORACLEMINUTES#1 | HOLD | *pooled over the sweep's arms* | 163–214 pts, 3 df | — | — | 0.021 (strictest arm) |
...
| ORACLEMINUTES#1 | **armband pinned** | ORACLE[info:minutes] season-average window | 158–207 pts | 74–105 pts | 2.03 | 0.154 |
| ORACLEMINUTES#1 | armband pinned | *pooled over the sweep's arms* | 166–217 pts, 3 df | — | — | 0.036 (strictest arm) |
...
| ORACLEMINUTES#1 | **nobody doubled** | ORACLE[info:minutes] season-average window | 166–217 pts | 62–87 pts | 3.23 | 0.052 |
...
| | |
|---|---|
| snapshot taken | 2026-08-10 23:52 EDT |
| commit | `13cded07a00a` |
| branch | `worktree-oracle-harness` |
| cells file | `/tmp/omin3/cells.csv, /tmp/verify/prices.csv` |
...
| | |
|---|---|
| ran at commit | `9c1a9731b984`, tree dirty |
...
| ORACLE[info:minutes] season-average window | alternative | 24 | 0 | complete |
...
|---|---:|---:|---:|---|
| HOLD (hold the opening fifteen, never transfer) | 4 | 96 | 82 | moved in 82 cells (worst: 2024-25 entered at GW6, ORACLE[info:minutes] season-average window: 2052 against 1762) |
| nobody doubled (HOLD with no captain at all) | 4 | 96 | 80 | moved in 80 cells (worst: 2023-24 entered at GW6, ORACLE[info:minutes] season-average window: 1719 against 1417) |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| ORACLEMINUTES#1 | **POLICY** | 1.539 | 0.538 | 2.347 | 1.813 | 72% | 28% | 0.001 |
| ORACLEMINUTES#1 | **HOLD** | 2.228 | 0.000 | 3.741 | 2.701 | 68% | 32% | 0.021 |
| ORACLEMINUTES#1 | **armband pinned** | 2.218 | 0.620 | 3.947 | 2.741 | 65% | 35% | 0.036 |
| ORACLEMINUTES#1 | **nobody doubled** | 2.398 | 1.083 | 3.231 | 2.737 | 77% | 23% | 0.010 |
...
Compared against `2026-08-10-7ae3466`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `harness.oracleminutes_1.mde_season.hold` | 224 | 214 | -10 |
| `harness.oracleminutes_1.mde_season.hold_fixedcap` | 220 | 217 | -3 |
| `harness.oracleminutes_1.mde_season.policy` | 142 | 143 | +1 |
| `harness.oracleminutes_1.mde_season.policy.oracle_info_lineups_perfect_lineups.clustered` | 175 | 182 | +7 |
| `harness.oracleminutes_1.mde_season.policy.oracle_info_lineups_perfect_lineups.startfixed` | 40 | 42 | +2 |
| `harness.oracleminutes_1.sd_resid.hold` | 3.563 | 3.741 | +0.178 |
| `harness.oracleminutes_1.sd_resid.hold_fixedcap` | 3.744 | 3.947 | +0.203 |
| `harness.oracleminutes_1.sd_resid.hold_nocap` | 3.040 | 3.231 | +0.191 |
| `harness.oracleminutes_1.sd_resid.policy` | 2.044 | 2.347 | +0.303 |
| `harness.oracleminutes_1.sd_season.hold` | 2.438 | 2.228 | -0.21 |
| `harness.oracleminutes_1.sd_season.hold_fixedcap` | 2.325 | 2.218 | -0.107 |
| `harness.oracleminutes_1.sd_season.hold_nocap` | 2.435 | 2.398 | -0.037 |
| `harness.oracleminutes_1.sd_season.policy` | 1.589 | 1.539 | -0.05 |
| `harness.oracleminutes_1.share_season.hold` | 74 | 68 | -6 |
| `harness.oracleminutes_1.share_season.hold_fixedcap` | 70 | 65 | -5 |
| `harness.oracleminutes_1.share_season.hold_nocap` | 79 | 77 | -2 |
| `harness.oracleminutes_1.share_season.policy` | 78 | 72 | -6 |
| `harness.oracleminutes_1.sig_season.hold` | 172 | 163 | -9 |
| `harness.oracleminutes_1.sig_season.hold_fixedcap` | 168 | 166 | -2 |
| `harness.oracleminutes_1.sig_season.policy` | 109 | 110 | +1 |
| `stamp.commit` | 7ae346682f59 | 13cded07a00a | — |
| `stamp.dirty` | true | false | — |
| `sweep.ORACLEMINUTES#1.arms` | 4 | 5 | +1 |
| `sweep.ORACLEMINUTES#1.commit` | d4df72bd0c74 | 9c1a9731b984 | — |
| `sweep.ORACLEMINUTES#1.invariance_differs.hold_hold_the_opening_fifteen_never_transfer` | 59 | 82 | +23 |
| `sweep.ORACLEMINUTES#1.invariance_differs.nobody_doubled_hold_with_no_captain_at_all` | 56 | 80 | +24 |
...
- `harness.oracleminutes_1.mde_season.policy.oracle_info_minutes_season_average_window.clustered` = 140
- `harness.oracleminutes_1.mde_season.policy.oracle_info_minutes_season_average_window.startfixed` = 70
- `harness.oracleminutes_1.mde_season.hold.oracle_info_minutes_season_average_window.clustered` = 177
- `harness.oracleminutes_1.mde_season.hold.oracle_info_minutes_season_average_window.startfixed` = 98
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_minutes_season_average_window.clustered` = 207
- `harness.oracleminutes_1.mde_season.hold_fixedcap.oracle_info_minutes_season_average_window.startfixed` = 105
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_minutes_season_average_window.clustered` = 217
- `harness.oracleminutes_1.mde_season.hold_nocap.oracle_info_minutes_season_average_window.startfixed` = 87
