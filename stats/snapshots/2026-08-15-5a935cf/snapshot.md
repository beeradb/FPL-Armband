...
| | |
|---|---|
| snapshot taken | 2026-08-15 10:00 EDT |
| commit | `5a935cf7e8c7` |
| branch | `retire-todo-md` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/58cd969d/tmp/model-retire-todo.csv` |
...
Compared against `2026-08-15-e056821`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | e056821b01d1 | 5a935cf7e8c7 | — |
