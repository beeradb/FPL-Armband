...
| | |
|---|---|
| snapshot taken | 2026-08-20 18:35 EDT |
| commit | `fca883376930` — **working tree was dirty**, so this commit alone does not identify the code that ran |
...
Compared against `2026-08-20-3d6fa48`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 3d6fa486561b | fca883376930 | — |
