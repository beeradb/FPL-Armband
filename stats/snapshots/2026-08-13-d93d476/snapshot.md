...
| | |
|---|---|
| snapshot taken | 2026-08-13 22:05 EDT |
| commit | `d93d476a1e96` — **working tree was dirty**, so this commit alone does not identify the code that ran |
| branch | `worktree-prior-half-life-on-repaired-xgc` |
| cells file | `not supplied` |
| model file | `/home/bbowman.guest/.claude/jobs/0590839a/tmp/model2.csv` |
...
Compared against `2026-08-13-66937f3`.

### Figures that moved

| figure | previous | now | change |
|---|---:|---:|---:|
| `stamp.commit` | 66937f3955a9 | d93d476a1e96 | — |
...
- `model.transfer_error.buy_side_player_bought.median` was -0.2559
- `model.transfer_error.buy_side_player_bought.mean` was -0.0524
- `model.transfer_error.sell_side_player_sold.median` was -0.3032
- `model.transfer_error.sell_side_player_sold.mean` was -0.2437
- `model.transfer_error.asymmetry_buy_minus_sell.median` was 0.0474
- `model.transfer_error.asymmetry_buy_minus_sell.mean` was 0.1913
- `model.transfer_error.sell_error_sold_player_played_again.median` was -0.1531
